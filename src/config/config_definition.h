...
#define DEFAULT_IMPORT_SCRIPT_FOLDER "import"
#define DEFAULT_PLAYLISTS_SCRIPT_FOLDER "playlists"
#define DEFAULT_METAFILE_SCRIPT_FOLDER "metadata"
#define DEFAULT_COMMON_SCRIPT_FOLDER "common"
