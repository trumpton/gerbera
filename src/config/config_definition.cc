...
const std::vector<std::shared_ptr<ConfigSetup>> ConfigDefinition::complexOptions = {
    ...
    std::make_shared<ConfigStringSetup>(CFG_IMPORT_SCRIPTING_CHARSET,
        ...
        DEFAULT_JS_CHARSET),
    std::make_shared<ConfigPathSetup>(CFG_IMPORT_SCRIPTING_COMMON_SCRIPT_FOLDER,
        "/import/scripting/common-script-folder", "config-import.html#common-script",
        "", true, false),
    std::make_shared<ConfigPathSetup>(CFG_IMPORT_SCRIPTING_CUSTOM_SCRIPT,
        ...
        "", true),
    std::make_shared<ConfigPathSetup>(CFG_IMPORT_SCRIPTING_CUSTOM_SCRIPT_FOLDER,
        "/import/scripting/custom-script-folder", "config-import.html#custom-script",
        "", true),
    std::make_shared<ConfigPathSetup>(CFG_IMPORT_SCRIPTING_PLAYLIST_SCRIPT_FOLDER,
        "/import/scripting/playlist-script-folder", "config-import.html#playlist-script",
	"",false,true),
    std::make_shared<ConfigPathSetup>(CFG_IMPORT_SCRIPTING_METAFILE_SCRIPT_FOLDER,
        "/import/scripting/metafile-script-folder", "config-import.html#metafile-script",
	"",false,true),
    ...
    std::make_shared<ConfigPathSetup>(CFG_IMPORT_SCRIPTING_IMPORT_SCRIPT,
        ...
        "", true),
    std::make_shared<ConfigPathSetup>(CFG_IMPORT_SCRIPTING_IMPORT_SCRIPT_FOLDER,
        "/import/scripting/virtual-layout/import-script-folder", "config-import.html#scripting-folder",
	"",false,true),
