...
enum config_option_t {
    ...
    CFG_IMPORT_SCRIPTING_COMMON_SCRIPT_FOLDER,
    CFG_IMPORT_SCRIPTING_CUSTOM_SCRIPT,
    CFG_IMPORT_SCRIPTING_CUSTOM_SCRIPT_FOLDER,
    CFG_IMPORT_SCRIPTING_METAFILE_SCRIPT_FOLDER,
    CFG_IMPORT_SCRIPTING_PLAYLIST_SCRIPT_FOLDER,
    CFG_IMPORT_SCRIPTING_PLAYLIST_SCRIPT_LINK_OBJECTS,
    CFG_IMPORT_SCRIPTING_IMPORT_SCRIPT,
    CFG_IMPORT_SCRIPTING_IMPORT_SCRIPT_FOLDER,
